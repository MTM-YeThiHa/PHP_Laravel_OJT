...
// Route::post('/register', [App\Http\Controllers\Auth\RegisterController::class, 'submitUserRegistration'])->name('userRegister');
Route::get('/post/search', [PostController::class, 'showPostList'])->name('postlist');
Route::post('/post/search', [PostController::class, 'filterPost'])->name('postSearch');
Route::get('user/search', [App\Http\Controllers\User\userController::class, 'showUserList'])->name('userlist');
Route::post('user/search', [App\Http\Controllers\User\userController::class, 'userSearch'])->name('userSearch');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::delete('/user/delete/{userId}', [UserController::class, 'deleteUserById'])->name('user.delete');
});
