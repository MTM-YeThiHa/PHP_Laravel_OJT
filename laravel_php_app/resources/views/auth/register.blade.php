                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control cursor-pointer" form-select @error('type') is-invalid @enderror" name="type">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="date" class="form-control cursor-pointer @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" autocomplete="dob">
