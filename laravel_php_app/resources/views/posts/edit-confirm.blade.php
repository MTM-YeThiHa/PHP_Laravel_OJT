            ...
            <div class="form-group row">
              ...
              <div class="col-md-6 mt-auto mb-auto">
                <div class="form-check form-switch">
                  @if(old('status'))
                  <input type="checkbox" class="form-check-input" id="flexSwitchCheckDefault" name="status" checked onclick="return false;">
                  <label class="custom-control-label" for="flexSwitchCheckDefault"></label>
                  @else
                  <input type="checkbox" class="form-check-input" id="flexSwitchCheckDefault" name="status" onclick="return false;">
                  <label class="custom-control-label" for="flexSwitchCheckDefault"></label>
                  @endif
                </div>
              </div>
